...
var json=JSON.stringify(ob);
parent.ccc_lib_reqDataByCmd("",RCD_CURVE_GETBYID,json,ShowModLine11);
}else{
if(!type||!ch){
...
ob.userData=parseInt(CheckedDevType);
var json=JSON.stringify(ob);
parent.ccc_lib_reqDataByCmd("intType",RCD_CURVE_GETBYID,json,ShowModLine1);
}
})
function hideBall(){
$(".watchBoll").hide().siblings("ul").show();
...
if(des.userData==1||des.userData==2||des.userData==3||des.userData==6){
...
if(des.yc[i].disSeq<=9&&des.yc[i].disSeq>0){
var tts=0;
...
if(des.yc[i].disSeq==1||des.yc[i].disSeq==4||des.yc[i].disSeq==7){
$(".modalInline .ycs>p:nth-child(1)").show();
}
if(des.yc[i].disSeq==2||des.yc[i].disSeq==5||des.yc[i].disSeq==8){
$(".modalInline .ycs>p:nth-child(2)").show();
}
if(des.yc[i].disSeq==3||des.yc[i].disSeq==6||des.yc[i].disSeq==9){
...
if(des.yc[i].disSeq<=3&&des.yc[i].disSeq>0){
for(var m=0;m<des.yc[i].arrs.length;m++){
...
loadGroupInfo();
for(var i=0;i<des.yc.length;i++){
if(des.yc[i].disSeq<=6){
var arr3=((des.yc[i].value).toFixed(1)).split("");
while(arr3.length<6){
arr3.unshift("0");
}
des.yc[i].arrs=arr3;
}else if(des.yc[i].disSeq>6&&des.yc[i].disSeq<=10){
...
}else if(des.userData==12){
$(".modalDCInput").show().addClass("active");
$(".modalDCInput .ycs1>div>b").html("无");
$(".modalDCInput .ycs2>div>b").html("无");
for(var i=0;i<des.yc.length;i++){
if((des.yc[i].disSeq>0&&des.yc[i].disSeq<=3)||(des.yc[i].disSeq>4&&des.yc[i].disSeq<=7)){
var arr3=((des.yc[i].value).toFixed(1)).split("");
while(arr3.length<6){
arr3.unshift("0");
}
...
}else if(des.yc[i].disSeq>4&&des.yc[i].disSeq<=7){
for(var m=0;m<des.yc[i].arrs.length;m++){
...
var str1,str2;
if(des.userData==13||des.userData==19){
...
}else if(des.userData==18||des.userData==25){
...
loadGroupInfo();
}else if(des.userData==16||des.userData==17){
...
}else if(des.userData==15){
$(".modalDCfeeder").show().addClass("active");
first=true;
ttPage=1;
loadGroupInfo();
}else if(des.userData==21){
$(".modalDetector").show().addClass("active");
first=true;
ttPage=1;
loadGroupInfo();
}else if(des.userData==23||des.userData==25){
...
}else if(des.userData==24||des.userData==22){
...
var str="";
var cla="";
if(des.yx[i].dataType==5||des.yx[i].dataType==7){
if(des.yx[i].value==0){
str='<span class="green">分</span>';
}else{
str='<span class="red">合</span>';
}
}else if(des.yx[i].dataType==2){
if(des.yx[i].disMode==0){
if(des.yx[i].value==0){
...
}else if(des.userData==1||des.userData==2||des.userData==3||des.userData==6){
...
ob.userData=parseInt(CheckedDevType);
var json=JSON.stringify(ob);
parent.ccc_lib_reqDataByCmd("",USER_ELEC_CLUSTER_GETBYID,json,showGroupInfo);
}
var BatNames;
...
if(data[i].data[k].dataType==1||data[i].data[k].dataType==3||data[i].data[k].dataType==9){
tab+="<td>"+(data[i].data[k].value).toFixed(2)+" "+data[i].data[k].unit+"</td>";
}else if(data[i].data[k].dataType==5||data[i].data[k].dataType==7){
if(data[i].data[k].value==0){
tab+="<td class='green'>分</td>";
}else{
tab+="<td class='red'>合</td>";
}
}else if(data[i].data[k].dataType==2){
if(data[i].data[k].value==0){
...
if(des.dev[i].data[k].dataType==1||des.dev[i].data[k].dataType==3||des.dev[i].data[k].dataType==9){
...
var cla3="";
try{
if(des.dev[i].data[num].dataType==1||des.dev[i].data[num].dataType==3||des.dev[i].data[num].dataType==9){
...
if(des.dev[i].data[num+3].dataType==1||des.dev[i].data[num+3].dataType==3||des.dev[i].data[num+3].dataType==9){
...
if(des.dev[i].data[num+6].dataType==1||des.dev[i].data[num+6].dataType==3||des.dev[i].data[num+6].dataType==9){
...
}else if(des.dev[i].data[k].dataType==5||des.dev[i].data[k].dataType==6||des.dev[i].data[k].dataType==7){
...
}else if(des.dev[i].data[k].regId==51){
BatInters.push(val);
...
}else if(des.dev[i].data[k].regId==227){
BatTemps.push(val);
...
var json=JSON.stringify(ob);
console.log(json);
parent.ccc_lib_reqDataByCmd("",USER_CURVE_GROUP_LIST,json,ShowModLine1);
}
...
var json=JSON.stringify(ob);
console.log(json);
parent.ccc_lib_reqDataByCmd("",USER_ELEC_HEAT_LIST_V25,json,ShowModLine1);
}
...
chartLine1(timeData,valueData,"lineContent");
}else if(CheckedDevType==16||CheckedDevType==17){
chartLine1(timeData,valueData,"DCBuslineContent");
}else if(CheckedDevType==14){
chartLine1(timeData,valueData,"DCBatterylineContent");
}else if(CheckedDevType==18||CheckedDevType==13||CheckedDevType==19||CheckedDevType==25){
chartLine1(timeData,valueData,"DCChargerlineContent");
}else if(CheckedDevType==12){
chartLine1(timeData,valueData,"DCInpulineContent");
}else if(CheckedDevType==22||CheckedDevType==24){
chartLine1(timeData,valueData,"INVPowerlineContent");
}else if(des.userData==23||des.userData==25){
chartLine1(timeData,valueData,"INVfeederContent");
}else if(des.userData==20){
...
var json=JSON.stringify(ob);
console.log(json);
parent.ccc_lib_reqDataByCmd("",USER_ELEC_HEAT_LIST_V25,json,ShowModLine3);
}
...
datas.num=oDataView.getUint32(pos,false);
pos+=4;
for(var i=0;i<datas.num;i++){
var obj={};
let timeLen=oDataView.getUint16(pos,false);
pos+=2;
obj.time="";
...
var json=JSON.stringify(ob);
console.log(json);
parent.ccc_lib_reqDataByCmd("",USER_ELEC_HEAT_LIST_V25,json,ShowModLine4);
}
...
var odtop=document.getElementById(idTop);
if(od&&odtop){
